...
const Icon = TypedRecord<IconFunctionalComponent>()({
  ...
  FriendMessage: function ({ className }) {
    return (
      <svg
        className={className}
        aria-hidden="false"
  ...
  FriendBlock: function ({ className }) {
    return (
      <svg
        className={className}
        aria-hidden="false"
  ...
  ActionAccept: function ({ className }) {
    return (
      <svg
        className={className}
        aria-hidden="false"
  ...
  EmptyPrivateChannelList: function ({ className }) {
    return (
      <svg className={className} width="216" height="460" viewBox="0 0 184 428">
