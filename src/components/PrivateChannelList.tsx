...
function PrivateChannelList({ className = "" }: props) {
    ...
    const privateChannelList = privateChannels.map((privateChannel) => {
        return (
            <div key={privateChannel.participants[0]} className="flex-none rounded-[0.25rem] h-[2.625rem] flex items-center justify-start ml-[0.5rem] my-[0.0625rem] px-2  text-channel-default hover:text-interactive-hover hover:bg-modifier-hover cursor-pointer active:bg-[rgba(79,84,92,0.24)] active:text-white group">
    ...
    return (
        <div className={className}>
            ...
            <div className="pt-2 flex flex-col overflow-y-scroll -webkit-scrollbar:w-2 -webkit-scrollbar:h-2 -webkit-scrollbar-thumb:bg-clip-padding -webkit-scrollbar-thumb:border-2 -webkit-scrollbar-thumb:border-solid -webkit-scrollbar-thumb:border-transparent -webkit-scrollbar-thumb:rounded -webkit-scrollbar-thumb:bg-transparent hover:-webkit-scrollbar-thumb:bg-tertiary -webkit-scrollbar-thumb:min-h-[2.5rem]">
                <div className="flex-none rounded-[0.25rem] h-[2.625rem] flex items-center justify-start ml-[0.5rem]  text-channel-default hover:text-interactive-hover hover:bg-modifier-hover cursor-pointer active:bg-[rgba(79,84,92,0.24)] active:text-white">
                ...
                <div className="flex-none flex items-center justify-between pt-[1.125rem] pr-[0.5rem] pb-[0.25rem] pl-[1.125rem] text-channel-default hover:text-interactive-hover">
